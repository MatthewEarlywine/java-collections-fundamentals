...
public class ArrayListExamples
{
    public static void main(String[] args)
    {
        ...
        System.out.println("---------------We can query for size-------------");
        System.out.println(products.size());

        // Lists have order, we retrieve elements by index
        System.out.println("------------Lists have order, we retrieve elements by index--------------");
        ...
        System.out.println("-------------------can loop over them with a for loop-----------------");
